...
class Karyawan_model extends CI_Model
{
    ...
    {
        $sql = "SELECT a.id,a.id_karyawan,a.nama_karyawan,b.nama_jabatan,c.nama_shift,a.gedung_id,a.email
    ...
    {
        $sql = "SELECT a.id_karyawan,a.nama_karyawan,b.nama_jabatan,d.nama_shift,c.nama_gedung,a.email
    ...
    function getData()
    {
        $this->datatables->select('a.id,a.id_karyawan,a.nama_karyawan,b.nama_jabatan,d.nama_shift,c.nama_gedung,a.email')
            ->from('karyawan as a,jabatan as b,gedung as c,shift as d')
            ->where('b.id_jabatan=a.jabatan')
