...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'redsihelma@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'redsi helma'; // Isikan dengan nama pengirim
    protected $password = 'opxbzudimxmqmkws'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        if($data['attachment']['size'] <= 25000000){ // Jika ukuran file <= 25 MB (25.000.000 bytes)
            ...
            if($send){ // Jika Email berhasil dikirima
